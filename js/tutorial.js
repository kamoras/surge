...
const HINTS = [
  ...
  { id: 'dash',    trigger: g => g.time > 6 && g.player && g.player.hp < g.player.maxHp * 0.85,
    text: 'Press SPACE to dash through enemies' },
  { id: 'levelup', trigger: g => g.level === 2 && g.state === 'playing',
    text: 'Pick an upgrade -- each one shapes your build' },
  { id: 'elite',   trigger: g => g.enemies.some(e => e.isElite),
