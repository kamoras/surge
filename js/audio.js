...
export const Sound = (() => {
  ...
  /** A single pitched tone, optionally sliding to `slideTo`. */
  ...
  /** A burst of band-passed white noise (impacts / explosions). */
  ...
  return {
    ...
    kill()   { noise(0.12, 0.22, 600); blip(180, 0.12, 'sawtooth', 0.12, 90); },
